...
var require_styles = __commonJS({
  "src/plugin/css/styles.json"(exports, module) {
    module.exports = {
      ":root": {
...
var getSemanticTokensCssVars = (color) => {
  return match(color).with("neutral", () => ({})).with("amber", "lime", "mint", "sky", "yellow", () => ({
...
var getBorderRadiusCssVars = (borderRadius) => {
  if (!borderRadius)
    return {};
  const borderRadii = match(borderRadius).with("none", () => ({
    l1: "radii-none",
    l2: "radii-none",
    l3: "radii-none"
  })).with("xs", () => ({
...
// src/plugin/plugin.ts
var parkwindPlugin = plugin(({ addComponents, config }) => {
...
export {
  parkwindPlugin,
  preset_default as parkwindPreset
};

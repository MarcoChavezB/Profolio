...
const radioGroup__namespace = /*#__PURE__*/_interopNamespaceDefault(radioGroup);
...
const useSegmentGroup = (props, emit) => {
  ...
  return vue.computed(() => radioGroup__namespace.connect(state.value, send, vue$1.normalizeProps));
};

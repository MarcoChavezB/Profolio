...
const ColorPickerChannelSliderThumb = /* @__PURE__ */ vue.defineComponent((_, {
  slots,
  attrs
}) => {
  ...
  return () => vue.createVNode(factory.ark.div, vue.mergeProps(api.value.getChannelSliderThumbProps(sliderProps), attrs), {

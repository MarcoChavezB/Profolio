...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"root" | "label" | "tree" | "item" | "itemText" | "branch" | "branchControl" | "branchTrigger" | "branchContent" | "branchText" | "branchIndicator">;
...
interface BranchProps extends ItemProps {
}
interface ItemState {
    id: string;
    isDisabled: boolean;
...
interface BranchState extends ItemState {
    isExpanded: boolean;
}

    ...
    treeProps: normalize.element({
      ...
      onKeyDown(event) {
        ...
        const keyMap = {
          ...
          ArrowLeft(event2) {
            if (isModifiedEvent(event2) || node.dataset.disabled)
              return;
            event2.preventDefault();
...
import { getByTypeahead as getByTypeahead2, isHTMLElement as isHTMLElement2 } from "@zag-js/dom-query";

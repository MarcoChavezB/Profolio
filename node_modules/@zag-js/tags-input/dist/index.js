...
function connect(state, send, normalize) {
  ...
  return {
    ...
    rootProps: normalize.element({
      ...
      "data-focus": (0, import_dom_query2.dataAttr)(isInputFocused),
      "data-empty": (0, import_dom_query2.dataAttr)(isEmpty),
...
var set = {
  ...
  highlightedId: (ctx, id) => {
    if ((0, import_utils.isEqual)(ctx.highlightedTagId, id))
      return;

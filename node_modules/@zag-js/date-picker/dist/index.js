...
function formatValue(ctx) {
  const formatter = new import_date.DateFormatter(ctx.locale, {
...
function connect(state, send, normalize) {
  ...
  function focusMonth(month) {
    const value = (0, import_date_utils.setMonth)(focusedValue ?? (0, import_date_utils.getTodayDate)(timeZone), month);
    send({ type: "FOCUS.SET", value });
  }
  function focusYear(year) {
    const value = (0, import_date_utils.setYear)(focusedValue ?? (0, import_date_utils.getTodayDate)(timeZone), year);
    send({ type: "FOCUS.SET", value });
  }
  function getYearTableCellState(props) {
    ...
    const cellState = {
      ...
      isSelectable: !(0, import_date_utils.isDateInvalid)(normalized, min, max),
  ...
  function getDayTableCellState(props) {
    ...
    const cellState = {
      isInvalid: (0, import_date_utils.isDateInvalid)(value, min, max),
      isDisabled: disabled2 || (0, import_date_utils.isDateDisabled)(value, visibleRange.start, end, min, max),
      isSelected: selectedValue.some((date) => (0, import_date_utils.isDateEqual)(value, date)),
      isUnavailable: (0, import_date_utils.isDateUnavailable)(value, isDateUnavailableFn, locale, min, max) && !disabled2,
      isOutsideRange: (0, import_date_utils.isDateOutsideVisibleRange)(value, visibleRange.start, end),
      isInRange: isRangePicker && (isDateWithinRange(value, selectedValue) || isDateWithinRange(value, hoveredRangeValue)),
      isFirstInRange: isRangePicker && (0, import_date_utils.isDateEqual)(value, selectedValue[0]),
      isLastInRange: isRangePicker && (0, import_date_utils.isDateEqual)(value, selectedValue[1]),
      isToday: (0, import_date_utils.isTodayDate)(value, timeZone),
      isWeekend: (0, import_date2.isWeekend)(value, locale),
      formattedDate: formatter.format(value.toDate(timeZone)),
      get isFocused() {
        return (0, import_date_utils.isDateEqual)(value, focusedValue) && !cellState.isOutsideRange;
      },
      get ariaLabel() {
  ...
  return {
    ...
    getDayTableCellProps(props) {
      ...
      return normalize.element({
        ...
        role: "gridcell",
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.isSelectable),
        "aria-selected": cellState.isSelected || cellState.isInRange,
        "aria-invalid": (0, import_dom_query2.ariaAttr)(cellState.isInvalid),
    ...
    getDayTableCellTriggerProps(props) {
      ...
      return normalize.element({
        ...
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.isSelectable),
        "aria-invalid": (0, import_dom_query2.ariaAttr)(cellState.isInvalid),
        "data-disabled": (0, import_dom_query2.dataAttr)(!cellState.isSelectable),
        "data-selected": (0, import_dom_query2.dataAttr)(cellState.isSelected),
        "data-value": value.toString(),
        "data-view": "day",
        "data-today": (0, import_dom_query2.dataAttr)(cellState.isToday),
        "data-focused": (0, import_dom_query2.dataAttr)(cellState.isFocused),
        "data-unavailable": (0, import_dom_query2.dataAttr)(cellState.isUnavailable),
        "data-range-start": (0, import_dom_query2.dataAttr)(cellState.isFirstInRange),
        "data-range-end": (0, import_dom_query2.dataAttr)(cellState.isLastInRange),
        "data-in-range": (0, import_dom_query2.dataAttr)(cellState.isInRange),
        "data-outside-range": (0, import_dom_query2.dataAttr)(cellState.isOutsideRange),
        "data-weekend": (0, import_dom_query2.dataAttr)(cellState.isWeekend),
        onClick() {
    ...
    getMonthTableCellProps(props) {
      ...
      return normalize.element({
        ...
        colSpan: columns,
        role: "gridcell",
        "aria-selected": (0, import_dom_query2.ariaAttr)(cellState.isSelected),
        "data-selected": (0, import_dom_query2.dataAttr)(cellState.isSelected),
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.isSelectable),
        "data-value": value
      });
...
var transformContext = (ctx) => {
  ...
  value = value.map((date) => (0, import_date_utils2.constrainValue)(date, ctx.min, ctx.max));
    ...
    },
    {
      ...
      actions: {
        ...
        setFocusedDate(ctx2, evt) {
          ...
          set.focusedValue(ctx2, (0, import_date_utils2.constrainValue)(value, ctx2.min, ctx2.max));
        },
        ...
        adjustStartDate(ctx2) {
          const adjust = (0, import_date_utils2.getAdjustedDateFn)(ctx2.visibleDuration, ctx2.locale, ctx2.min, ctx2.max);
        ...
        focusNextSection(ctx2, evt) {
          const section = (0, import_date_utils2.getNextSection)(
            ctx2.focusedValue,
            ctx2.startValue,
            evt.larger,
        ...
        focusPreviousSection(ctx2, evt) {
          const section = (0, import_date_utils2.getPreviousSection)(
            ctx2.focusedValue,
            ctx2.startValue,
            evt.larger,
            ctx2.visibleDuration,
        ...
        focusParsedDate(ctx2, evt) {
          ...
          const date = (0, import_date_utils2.parseDateString)(ctx2.inputValue, ctx2.locale, ctx2.timeZone);
...
var set = {
  ...
  focusedValue(ctx, value) {
    if (!value || (0, import_date_utils2.isDateEqual)(ctx.focusedValue, value))
      return;
    ctx.focusedValue = value;
    invoke.focusChange(ctx);
  },
  view(ctx, value) {
    if ((0, import_utils3.isEqual)(ctx.view, value))
      return;
    ctx.view = value;

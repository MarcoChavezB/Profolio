  ...
  return {
    ...
    getItemProps(props) {
      ...
      return normalize.element({
        ...
        "aria-disabled": (0, import_dom_query2.ariaAttr)(itemState.isDisabled),
        onPointerMove(event) {
    ...
    },
    {
      ...
      activities: {
        proxyTabFocus(ctx2) {
          ...
          return (0, import_tabbable.proxyTabFocus)(contentEl, {
            defer: true,
      ...
      actions: {
        ...
        syncSelectElement(ctx2) {
          ...
          if (!selectEl)
            return;
          (0, import_form_utils.setElementValue)(selectEl, ctx2.value.join(","), { type: "HTMLSelectElement" });
        },
...
var set = {
  selectedItem: (ctx, value, force = false) => {
    ...
    const nextValue = ctx.multiple ? (0, import_utils.addOrRemove)(ctx.value, value) : [value];
    ctx.value = nextValue;
    invoke.change(ctx);
  },

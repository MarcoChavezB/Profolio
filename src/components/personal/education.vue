<template>
    <section class="h-full w-full grid">
        <div class="img flex justify-center ">
            <div class="ico">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="150" height="150" color="#171717"
                    fill="none">
                    <path
        ...
        <article class="">
            <p class="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
                Actualmente estoy cursando la carrera de Sistemas en la Universidad Tecnológica de Torreón. Mi educación
                formal en esta
                prestigiosa institución me proporciona una sólida base teórica en tecnología de la información, la cual
                complemento con aprendizaje
                autodidacta y proyectos prácticos fuera del aula.
            </p>
            <p class="mb-4 text-xl font-normal text-gray-500 dark:text-gray-400">
                Estoy comprometido con mi
                crecimiento académico y profesional, y estoy emocionado por aplicar lo que aprendo en el mundo real para
                hacer una diferencia en el campo de la tecnología
            </p>
        </article>
    </section>
</template>
